...
namespace FileFormat.Slides.Facade
    ...
    public class SlideFacade
        ...
        public TextShapeFacade AddTextShape(String text, Int32 fontSize, TextAlignment alignment, TextAnchor anchor, Int64 _x, Int64 _y,
    ...
    Int64 width, Int64 height, String backgroundColor, CircleShapeFacade facade)
        ...
        public TextShapeFacade AddTextListShape(List<String> textList, ListFacade facade, Int32 fontSize, TextAlignment alignment, TextAnchor anchor, Int64 _x, Int64 _y,
            Int64 width, Int64 height, String fontFamily, String textColor, String backgroundColor)
            {
            // Create an instance of TextShapeFacade
            TextShapeFacade textShapeFacade = new TextShapeFacade();
        ...
        public TextShapeFacade AddTextShape(List<TextSegmentFacade> textSegmentFacades, TextAlignment alignment, TextAnchor anchor, Int64 _x, Int64 _y,
