...
namespace FileFormat.Slides.Facade
    ...
    public class TextShapeFacade
        ...
        public TextShapeFacade WithAnchor(TextAnchor anchor)
            {
            Anchor = anchor;
            return this;
            }
        ...
        public P.Shape CreateShape()
            ...
            TextAnchoringTypeValues anchorType = ConvertAnchorToTypeValues(Anchor);
            ...
            shape1.Append(CreateTextBody(_TextColor, _FontFamily, _fontSize, _Text, alignmentType, anchorType));
        ...
        public P.Shape CreateShape(List<TextSegmentFacade> textSegmentFacades)
            ...
            if (_BackgroundColor is null)
                ...
                shape1.Append(CreateShapeProperties(X, Y, Width, Height, BackgroundColor));
            shape1.Append(CreateShapeStyle());
            shape1.Append(CreateTextBody(textSegmentFacades, alignmentType, anchorType));
        ...
        private P.TextBody CreateTextBody(string textColor, string font, int fontSize, string Text, TextAlignmentTypeValues alignmentType, TextAnchoringTypeValues anchorType)
            {
            P.TextBody textBody1 = new P.TextBody();
            D.BodyProperties bodyProperties1 = new D.BodyProperties() { RightToLeftColumns = false, Anchor = anchorType };
        ...
        private P.TextBody CreateTextBody(List<TextSegmentFacade> textSegmentFacades, TextAlignmentTypeValues alignmentType, TextAnchoringTypeValues anchorType)
            {
            P.TextBody textBody1 = new P.TextBody();
            D.BodyProperties bodyProperties1 = new D.BodyProperties() { RightToLeftColumns = false, Anchor = anchorType };
            D.ListStyle listStyle1 = new D.ListStyle();
        ...
        public static List<TextShapeFacade> PopulateTextShapes(SlidePart slidePart)
            ...
            foreach (var shape in shapes)
                ...
                var textShapeFacade = new TextShapeFacade
                    ...
                    Anchor = GetAnchorFromTextShape(shape),
        ...
        private static TextAnchor GetAnchorFromTextShape(P.Shape textShape)
            {
            var anchor = textShape.TextBody?.Descendants<BodyProperties>().FirstOrDefault()?.Anchor ?? TextAnchoringTypeValues.Center;
            return ConvertAnchorFromTypeValues(anchor);
            }
        ...
        private static TextAnchoringTypeValues ConvertAnchorToTypeValues(TextAnchor alignment)
            {
            switch (alignment)
                {
                case TextAnchor.Top:
                    return TextAnchoringTypeValues.Top;
                case TextAnchor.Center:
                    return TextAnchoringTypeValues.Center;
                case TextAnchor.Bottom:
                    return TextAnchoringTypeValues.Bottom;
                default:
                    throw new ArgumentOutOfRangeException(nameof(alignment), alignment, null);
                }
            }

        private static TextAnchor ConvertAnchorFromTypeValues(TextAnchoringTypeValues anchorType)
            {
            if (anchorType.Equals(TextAnchoringTypeValues.Top))
                return TextAnchor.Top;
            if (anchorType.Equals(TextAnchoringTypeValues.Bottom))
                return TextAnchor.Bottom;
            if (anchorType.Equals(TextAnchoringTypeValues.Center))
                return TextAnchor.Center;

            throw new ArgumentOutOfRangeException(nameof(anchorType), anchorType, null);
            }
        }
    }
